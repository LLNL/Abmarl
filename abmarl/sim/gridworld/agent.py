...
class SellerAgent(GridWorldAgent):
    """
    Agent that can set prices and sell goods.
    """
    def __init__(self, initial_money=1, initial_price=1, **kwargs):
        super().__init__(**kwargs)
    ...
    def initial_money(self):
        """
        How much money the agent starts with.
        """
        return self._initial_money

    @initial_money.setter
    def initial_money(self, value):
        assert type(value) in [int, float], "Money must be numeric."
        self._initial_money = value

    @property
    def money(self):
        """
        How much money the agent has.
        """
        return self._money
    ...
    def money(self, value):
        assert type(value) in [int, float], "Money must be numeric."
        self._money = value
        self.active = self.money > 0

    @property
    def initial_price(self):
        """
        The initial cost of goods that the agent is selling.
        """
        return self._initial_price

    @initial_price.setter
    def initial_price(self, value):
        assert type(value) in [int, float], "Price must be numeric."
        self._initial_price = value

    @property
    def price(self):
        """
        The cost of goods that the agent is selling.
        """
        return self._price
    ...
    def income(self):
        """
        The income the agent might make in this step.
        """
        return self._income

    @income.setter
    def income(self, value):
        assert type(value) in [int, float], "Income must be numeric."
        self._income = value


class BuyerAgent(GridWorldAgent):
    """
    Agent that can buy goods and has a preferred seller.
    """
    def __init__(self, initial_money=1, **kwargs):
        super().__init__(**kwargs)
        self.initial_money = initial_money
    ...
    def preference(self):
        """
        Buyer agent prefers to buy from this seller agent.
        """
    ...
    def money(self):
        """
        How much money the agent has to buy goods.
        """
        return self._money
