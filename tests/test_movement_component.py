...
def test_grid_movement_component():
    ...
    component.act(agents['agent0'], np.array([-1,  1]))
    component.act(agents['agent1'], np.array([ 0,  1]))
    component.act(agents['agent2'], np.array([ 0, -1]))
    component.act(agents['agent3'], np.array([ 1,  0]))
    ...
    component.act(agents['agent0'], np.array([ 2, -2]))
    component.act(agents['agent1'], np.array([-3,  0]))
    component.act(agents['agent2'], np.array([-1,  0]))
    component.act(agents['agent3'], np.array([ 1,  1]))
