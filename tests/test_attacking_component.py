...
from admiral.envs.components.actor import PositionBasedAttackActor, PositionTeamBasedAttackActor
...
def test_position_team_based_attack_actor():
    agents = {
        'agent0': AttackTeamTestAgent(id='agent0', attack_range=1, initial_position=np.array([1, 1]), \
            attack_strength=0.6, team=1),
        'agent1': AttackTeamTestAgent(id='agent1', attack_range=1, initial_position=np.array([0, 1]), \
            attack_strength=0.6, team=2),
        'agent2': AttackTeamTestAgent(id='agent2', attack_range=1, initial_position=np.array([4, 2]), \
            attack_strength=0.6, team=1),
        'agent3': AttackTeamTestAgent(id='agent3', attack_range=1, initial_position=np.array([4, 3]), \
            attack_strength=0.6, team=1),
        'agent4': AttackTeamTestAgent(id='agent4', attack_range=0, initial_position=np.array([3, 2]), \
            attack_strength=0.6, team=3),
        'agent5': AttackTeamTestAgent(id='agent5', attack_range=2, initial_position=np.array([4, 0]), \
            attack_strength=0.6, team=1),
    }
