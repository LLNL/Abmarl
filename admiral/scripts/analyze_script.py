...
def create_parser(subparsers):
    ...
    analyze_parser.add_argument('configuration', type=str, \
        help='Path to saved policy directory.')
    analyze_parser.add_argument('subscript', type=str, \
        help='Path to subscript to run.')
    analyze_parser.add_argument('-c','--checkpoint', type=int, \
